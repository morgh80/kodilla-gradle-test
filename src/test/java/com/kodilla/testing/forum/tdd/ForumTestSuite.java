...
public class ForumTestSuite {
    ...
    public void testAddComment() {
        //Given
        ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
        ForumPost post = new ForumPost("Hello everyone, " +
                "this is my first contribution here!", "mrsmith");
        ForumComment comment = new ForumComment(post, "Thank you for all good words!", "mr. smith");

        //When
        forumUser.addComment(post, comment);
    ...
    public void testGetComment() {
        ...
        ForumPost post = new ForumPost("Hello everyone, " +
                "this is my first contribution here!", "mrsmith^");
        ForumComment comment = new ForumComment(post, "Thank you for all good words!",
                "mrsmith@");
        forumUser.addComment(post, comment);
    ...
    public void testRemoveComment() {
        ...
        ForumPost post = new ForumPost("Hello everyone, " +
                "this is my first contribution here!", "mrsmith");
        ForumComment comment = new ForumComment(post, "mrsmith",
                "Thank you for all good words!");
        forumUser.addComment(post, comment);
